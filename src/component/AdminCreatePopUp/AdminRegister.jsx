                    ...
                    <Container>
                        <form onSubmit={New_Admin_Handler}>
                            ...
                            <input
                                ...
                                required
                            />
                            <button className="btn btn-primary" style={{ marginRight: "7px", marginTop: "9px" }}>Register</button>
                            <button className="btn btn-danger" onClick={Close_Form} style={{ marginTop: "9px" }}>
                                Close
                            </button>
                        </form>
                    </Container>
